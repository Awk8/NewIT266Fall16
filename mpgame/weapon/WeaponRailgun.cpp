...
class rvWeaponPowerfulBox : public rvWeapon {
public:

	CLASS_PROTOTYPE( rvWeaponPowerfulBox );

	rvWeaponPowerfulBox ( void );
...
private:
	...
	CLASS_STATES_PROTOTYPE ( rvWeaponPowerfulBox );
};

CLASS_DECLARATION( rvWeapon, rvWeaponPowerfulBox )
END_CLASS

/*
================
rvWeaponPowerfulBox::rvWeaponPowerfulBox
================
*/
rvWeaponPowerfulBox::rvWeaponPowerfulBox ( void ) {
}

/*
================
rvWeaponPowerfulBox::UpdateFlashlight
================
*/
bool rvWeaponPowerfulBox::UpdateFlashlight ( void ) {
	if ( !wsfl.flashlight ) {
		return false;
	}
...
/*
================
rvWeaponPowerfulBox::Flashlight
================
*/
void rvWeaponPowerfulBox::Flashlight ( bool on ) {
	owner->Flashlight ( on );
...
/*
================
rvWeaponPowerfulBox::UpdateAttack
================
*/
bool rvWeaponPowerfulBox::UpdateAttack ( void ) {
	// Clear fire forced
	if ( fireForced ) {
		if ( !wsfl.attack ) {
			fireForced = false;
...
/*
================
rvWeaponPowerfulBox::Spawn
================
*/
void rvWeaponPowerfulBox::Spawn ( void ) {
...
/*
================
rvWeaponPowerfulBox::Save
================
*/
void rvWeaponPowerfulBox::Save ( idSaveGame *savefile ) const {
...
/*
================
rvWeaponPowerfulBox::Restore
================
*/
void rvWeaponPowerfulBox::Restore ( idRestoreGame *savefile ) {
...
/*
================
rvWeaponPowerfulBox::PreSave
================
*/
void rvWeaponPowerfulBox::PreSave ( void ) {
...
/*
================
rvWeaponPowerfulBox::PostSave
================
*/
void rvWeaponPowerfulBox::PostSave ( void ) {
}
...
CLASS_STATES_DECLARATION ( rvWeaponPowerfulBox )
	STATE ( "Raise",						rvWeaponPowerfulBox::State_Raise )
	STATE ( "Lower",						rvWeaponPowerfulBox::State_Lower )
	STATE ( "Idle",							rvWeaponPowerfulBox::State_Idle)
	STATE ( "Charge",						rvWeaponPowerfulBox::State_Charge )
	STATE ( "Charged",						rvWeaponPowerfulBox::State_Charged )
	STATE ( "Fire",							rvWeaponPowerfulBox::State_Fire )
	STATE ( "Flashlight",					rvWeaponPowerfulBox::State_Flashlight )
END_CLASS_STATES

/*
================
rvWeaponPowerfulBox::State_Raise
================
*/
stateResult_t rvWeaponPowerfulBox::State_Raise( const stateParms_t& parms ) {
	enum {
		RAISE_INIT,
		RAISE_WAIT,
	};	
...
/*
================
rvWeaponPowerfulBox::State_Lower
================
*/
stateResult_t rvWeaponPowerfulBox::State_Lower ( const stateParms_t& parms ) {
	enum {
		LOWER_INIT,
		LOWER_WAIT,
		LOWER_WAITRAISE
...
/*
================
rvWeaponPowerfulBox::State_Idle
================
*/
stateResult_t rvWeaponPowerfulBox::State_Idle ( const stateParms_t& parms ) {	
	enum {
		IDLE_INIT,
		IDLE_WAIT,
	};	
...
/*
================
rvWeaponPowerfulBox::State_Charge
================
*/
stateResult_t rvWeaponPowerfulBox::State_Charge ( const stateParms_t& parms ) {
	enum {
		CHARGE_INIT,
		CHARGE_WAIT,
	};	
...
/*
================
rvWeaponPowerfulBox::State_Charged
================
*/
stateResult_t rvWeaponPowerfulBox::State_Charged ( const stateParms_t& parms ) {
	enum {
		CHARGED_INIT,
		CHARGED_WAIT,
	};	
...
/*
================
rvWeaponPowerfulBox::State_Fire
================
*/
stateResult_t rvWeaponPowerfulBox::State_Fire ( const stateParms_t& parms ) {
	enum {
		FIRE_INIT,
		FIRE_WAIT,
	};	
...
/*
================
rvWeaponPowerfulBox::State_Flashlight
================
*/
stateResult_t rvWeaponPowerfulBox::State_Flashlight ( const stateParms_t& parms ) {
	enum {
		FLASHLIGHT_INIT,
		FLASHLIGHT_WAIT,
	};	
